...
class _ProjectDetailPageState extends State<ProjectDetailPage> {
  ...
  void _navigateToDetailPage(int idTahapan, String namaTahapan) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) =>
            DetailTahapanPage(idTahapan: idTahapan, namaTahapan: namaTahapan),
      ),
    );
  }
  ...
  Future<void> fetchPhases() async {
    try {
      final response = await http.get(
        Uri.parse(
          'http://dev.quinsis.co.id/flask/api/tahapan?ID_project=${widget.projectId}',
        ),
      );
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return GestureDetector(
                    onTap: () {
                      _navigateToDetailPage(phase.idTahapan, phase.namaTahapan);
                    },
                    child: Container(
...
class _UploadTahapanPageState extends State<UploadTahapanPage> {
  ...
  Future<void> _submitData() async {
    ...
    final url = Uri.parse("http://dev.quinsis.co.id/admin/uploadFile");
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Center(
            child: Text(
              "${widget.namaTahapan}".toUpperCase(),
              style: TextStyle(
                fontWeight: FontWeight.bold,
                fontSize: 20,
              ),
              textAlign: TextAlign
                  .center, // Ini mengatur teks menjadi berada di tengah
            ),
          ),
          TextField(
